...
public class DriveCommand extends Command {
	...
	public void execute() {
		...
		// RobotContainer.drivetrainSubsystem.getPose2d().getRotation().getRadians() +
		// angleToTarget);
		// request = driveRobotCentric.withVelocityX(-maxVelocity *
		// noteTrackSpeedMultiplier).withVelocityY(0);
		// driveRobotCentric.withRotationalRate(rotationController
		// .calculate(RobotContainer.drivetrainSubsystem.getPose2d().getRotation().getRadians(),
		// 0.02)
		// * maxRotationalVelocity * .3).withRotationalDeadband(0);
		// driveFieldCentric.withRotationalRate(rotationController
		// .calculate(RobotContainer.drivetrainSubsystem.getPose2d().getRotation().getRadians(),
