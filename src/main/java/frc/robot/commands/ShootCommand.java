...
public class ShootCommand extends Command {
	...
	@Override
	public void execute() {
		RobotContainer.shooterSubsystem.setTopMotorRPS(ShooterConstants.shootDps / 12.0 * .5);
		RobotContainer.shooterSubsystem.setBottomMotorRPS(ShooterConstants.shootDps / 12.0 * .5);
	}
