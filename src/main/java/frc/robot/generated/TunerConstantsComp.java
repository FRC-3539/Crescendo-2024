...
public class TunerConstantsComp {
	...
	//private static final double kBackLeftEncoderOffset = -0.7956;
	...
	public static final DriveSubsystem DriveTrain = new DriveSubsystem(DrivetrainConstants, FrontLeft, FrontRight,
			BackLeft, BackRight);
}
